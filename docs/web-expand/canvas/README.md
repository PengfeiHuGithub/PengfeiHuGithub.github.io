...
各种特效的源码地址：[poetries/canvas(opens new window)](https://github.com/poetries/canvas)
...
### [#](http://interview.poetries.top/fe-mobile-docs/docs/canvas.html#实现随机粒子特效)实现随机粒子特效
