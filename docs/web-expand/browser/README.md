...
![image-20210923181558556](C:\Users\PengfeiHu\AppData\Roaming\Typora\typora-user-images\image-20210923181558556.png)
...
![image-20210923181631413](C:\Users\PengfeiHu\AppData\Roaming\Typora\typora-user-images\image-20210923181631413.png)
...
![image-20210923181702791](C:\Users\PengfeiHu\AppData\Roaming\Typora\typora-user-images\image-20210923181702791.png)
...
![image-20210923181722116](C:\Users\PengfeiHu\AppData\Roaming\Typora\typora-user-images\image-20210923181722116.png)
...
![image-20210923181742949](C:\Users\PengfeiHu\AppData\Roaming\Typora\typora-user-images\image-20210923181742949.png)
...
![image-20210923181755929](C:\Users\PengfeiHu\AppData\Roaming\Typora\typora-user-images\image-20210923181755929.png)
...
![image-20210923181810034](C:\Users\PengfeiHu\AppData\Roaming\Typora\typora-user-images\image-20210923181810034.png)
...
![image-20210923181820435](C:\Users\PengfeiHu\AppData\Roaming\Typora\typora-user-images\image-20210923181820435.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/2.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/3.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/4.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/5.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/6.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/7.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/8.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/9.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/10.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/11.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/12.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/13.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/14.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/15.png)

上面的标记过程和清除过程就是标记 - 清除算法，不过对一块内存多次执行标记 - 清除算法后，会产生大量不连续的内存碎片。而碎片过多会导致大对象无法分配到足够的连续内存，于是又产生了另外一种算法——标记 - 整理（Mark-Compact），这个标记过程仍然与标记 - 清除算法里的是一样的，但后续步骤不是直接对可回收对象进行清理，而是让所有存活的对象都向一端移动，然后直接清理掉端边界以外的内存。你可以参考下图

![img](http://blog.poetries.top/img-repo/2019/11/16.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/17.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/19.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/20.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/21.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/22.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/23.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/24.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/25.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/26.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/27.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/30.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/31.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/32.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/33.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/34.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/35.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/36.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/38.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/39.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/40.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/41.png) ![img](http://blog.poetries.top/img-repo/2019/11/42.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/43.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/44.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/45.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/46.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/47.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/48.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/49.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/50.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/51.png)

**1. 控制器**

其中，控制器有 4 个比较重要的功能，我们按照下文中的这张图来简单介绍下。

![img](http://blog.poetries.top/img-repo/2019/11/52.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/53.png)

**2. 详细信息**

如果你选中详细列表中的一项，右边就会出现该项的详细信息，如下所示：

![img](http://blog.poetries.top/img-repo/2019/11/54.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/55.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/56.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/57.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/65.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/66.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/67.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/68.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/69.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/70.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/71.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/72.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/73.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/74.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/75.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/76.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/77.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/78.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/81.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/82.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/83.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/86.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/89.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/90.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/91.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/92.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/93.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/94.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/95.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/96.png)

黑客拿到了用户 Cookie 信息之后，就可以利用 Cookie 信息在其他机器上登录该用户的账号（如下图），并利用用户账号进行一些恶意操作。

![img](http://blog.poetries.top/img-repo/2019/11/97.png)

以上就是存储型 XSS 攻击的一个典型案例，这是乌云网在 2015 年曝出来的，虽然乌云网由于某些原因被关停了，但是你依然可以通过这个站点来查看乌云网的一些备份信息。

### [#](https://blog.poetries.top/browser-working-principle/guide/part6/lesson33.html#_2-反射型-xss-攻击)2. 反射型 XSS 攻击
...
![img](http://blog.poetries.top/img-repo/2019/11/98.png)

> 但当打开`http://localhost:3000/?xss=<script>alert('你被xss攻击了')</script>`这段 URL 时，其结果如下图所示：

![img](http://blog.poetries.top/img-repo/2019/11/99.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/100.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/101.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/102.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/103.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/104.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/105.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/106.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/107.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/108.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/109.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/110.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/111.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/112.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/114.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/115.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/116.png)
...
![img](http://blog.poetries.top/img-repo/2019/11/117.png)
