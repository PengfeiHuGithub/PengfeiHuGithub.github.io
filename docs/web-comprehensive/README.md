...
![img](https://s.poetries.top/gitee/2020/07/18.png)

### 3 原型、构造函数、实例，以及原型链

![img](https://s.poetries.top/gitee/2020/07/19.png)

> PS：任何一个函数，如果在前面加了`new`，那就是构造函数。

#### 3.1 原型、构造函数、实例三者之间的关系

![img](https://s.poetries.top/gitee/2020/07/20.png)
...
![img](https://s.poetries.top/gitee/2020/07/21.png)
...
![img](https://s.poetries.top/gitee/2020/07/22.png)
...
![img](https://s.poetries.top/gitee/2020/07/41.png)
...
![img](https://s.poetries.top/gitee/2020/07/43.png)
...
![img](https://s.poetries.top/gitee/2020/07/44.png)
...
![img](https://s.poetries.top/gitee/2020/07/45.png)
...
![img](https://s.poetries.top/gitee/2020/07/46.png)
...
![img](https://s.poetries.top/gitee/2020/07/58.png) ![img](https://s.poetries.top/gitee/2020/07/59.png)
...
![img](https://s.poetries.top/gitee/2020/07/60.png)
...
![img](https://s.poetries.top/gitee/2020/07/69.png)
...
![img](https://s.poetries.top/gitee/2020/07/70.png) ![img](https://s.poetries.top/gitee/20190928/3.png)
...
![img](https://s.poetries.top/gitee/20190928/4.png)

![img](https://s.poetries.top/gitee/20190928/5.gif)

> 我们会看到的结果是，页面背景会在瞬间变成白色，以上代码属于同一次 宏任务，所以全部执行完才触发 页面渲染，渲染时 GUI线程会将所有UI改动优化合并，所以视觉效果上，只会看到页面变成灰色

**第二个例子：**

![img](https://s.poetries.top/gitee/20190928/6.png)

![img](https://s.poetries.top/gitee/20190928/7.gif)
...
![img](https://s.poetries.top/gitee/20190928/8.png)

![img](https://s.poetries.top/gitee/20190928/9.gif)

- 控制台输出 1 3 2 , 是因为 promise 对象的 then 方法的回调函数是异步执行，所以 2 最后输出
- 页面的背景色直接变成黑色，没有经过蓝色的阶段，是因为，我们在宏任务中将背景设置为蓝色，但在进行渲染前执行了微任务，在微任务中将背景变成了黑色，然后才执行的渲染

![img](https://s.poetries.top/gitee/20190928/10.png)
...
![img](https://s.poetries.top/gitee/20190928/11.png)
...
![img](https://s.poetries.top/gitee/2020/07/47.png)

`IE`盒子模型：

![img](https://s.poetries.top/gitee/2020/07/48.png)
...
![img](https://s.poetries.top/gitee/2020/07/49.png)
...
![img](https://s.poetries.top/gitee/2020/07/50.png)

父亲这个盒子：

![img](https://s.poetries.top/gitee/2020/07/51.png)
...
![img](https://s.poetries.top/gitee/2020/07/52.png)

> 此时我们给父亲`div`加一个`border`属性，就正常了：

![img](https://s.poetries.top/gitee/2020/07/53.png)
...
![img](https://s.poetries.top/gitee/2020/07/54.png)
...
![img](https://s.poetries.top/gitee/2020/07/55.png)
...
![img](https://s.poetries.top/gitee/2020/07/56.png)
...
![img](https://s.poetries.top/gitee/2020/07/57.png)
...
![img](https://s.poetries.top/gitee/2020/07/25.png)
...
![img](https://s.poetries.top/gitee/2020/07/26.gif)
...
![img](https://s.poetries.top/gitee/2020/07/27.gif)
...
![img](https://s.poetries.top/gitee/2020/07/28.gif)
...
![img](https://s.poetries.top/gitee/2020/07/29.gif)
...
![img](https://s.poetries.top/gitee/2020/07/17.png)
...
![img](https://s.poetries.top/gitee/2020/07/23.png)

#### 4.5 事件的触发顺序

![img](https://s.poetries.top/gitee/2020/07/24.png)
...
![img](https://s.poetries.top/gitee/2020/07/30.png)
...
![img](https://s.poetries.top/gitee/2020/07/31.png)
...
![img](https://s.poetries.top/gitee/2020/07/32.png)

上图中，红色那一栏表明，我的请求已经发出去了。点进去看看：

![img](https://s.poetries.top/gitee/2020/07/33.png)
...
![img](https://s.poetries.top/gitee/2020/07/34.png)
...
![img](https://s.poetries.top/gitee/2020/07/35.png)
...
![img](https://s.poetries.top/gitee/2020/07/36.png)
...
![img](https://s.poetries.top/gitee/2020/07/37.png)
...
![img](https://s.poetries.top/gitee/2020/07/38.png)

> 常见的`http`状态码：

![img](https://s.poetries.top/gitee/2020/07/39.png)
...
![img](https://s.poetries.top/gitee/2020/07/40.png)
